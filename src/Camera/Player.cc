...
namespace Camera
{
  ...
  Player::animate(Uint32 timestep)
  {
    ...
    _position +=
            Core::Vector3D(_forward._x /(fabs(_forward._x)+fabs(_forward._y)),
                           _forward._y /(fabs(_forward._x)+fabs(_forward._y)),
                           0) * (realspeed * timestep);
    ...
    if (input.isPressed("strafe_left"))
         ...
         _position +=
            Core::Vector3D(_left._x /(fabs(_left._x)+fabs(_left._y)),
                           _left._y /(fabs(_left._x)+fabs(_left._y)),
                           0) * (realspeed * timestep);
